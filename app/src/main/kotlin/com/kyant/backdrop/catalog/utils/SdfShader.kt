...
@Composable
fun rememberSdfShader(@DrawableRes drawableResId: Int): SdfShader {
    val context = LocalContext.current
    val image = remember(drawableResId) {
        loadImageBitmap(context, drawableResId)
    }
    return remember(image) { SdfShader(image) }
}

private fun loadImageBitmap(context: Context, @DrawableRes resId: Int): ImageBitmap {
